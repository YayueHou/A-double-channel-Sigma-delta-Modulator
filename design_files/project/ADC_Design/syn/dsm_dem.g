...
# Created by Genus(TM) Synthesis Solution 18.17-s015_1 on Tue Jan 10 02:20:54 PST 2023
...
set_db -quiet runtime_by_stage {{PBS_Generic-Start 0 21 0.0 7.0} {to_generic 8 30 7 14} {first_condense 4 35 3 19} {PBS_Generic_Opt-Post 14 35 11.999797999999998 18.999798} {{PBS_Generic-Postgen HBO Optimizations} 0 35 0.0 18.999798} {PBS_TechMap-Start 0 35 0.0 18.999798} {{PBS_TechMap-Premap HBO Optimizations} 0 35 0.0 18.999798} {first_condense 4 39 3 22} {reify 6 45 4 27} {global_incr_map 0 45 0 28} {{PBS_Techmap-Global Mapping} 11 46 9.999386000000001 28.999184} {{PBS_TechMap-Datapath Postmap Operations} 0 46 0.0 28.999184} {{PBS_TechMap-Postmap HBO Optimizations} 0 46 0.0 28.999184} {{PBS_TechMap-Postmap Clock Gating} 0 46 0.0 28.999184} {{PBS_TechMap-Postmap Cleanup} 0 46 0.0 28.999184} {PBS_Techmap-Post_MBCI 0 46 0.0 28.999184}}
set_db -quiet tinfo_tstamp_file .rs_eda.tstamp
set_db -quiet metric_enable true
set_db -quiet metric_page_cfg {}
set_db -quiet syn_map_effort medium
set_db -quiet flow_metrics_snapshot_uuid 0519eeec-6915-4421-8e8e-ef8bf8bd2d03
...
# END DFT SECTION
set_db -quiet design:dsm_dem_top .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 14456} {cell_count 4166} {utilization  0.00} {runtime 8 30 7 14} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 11510} {cell_count 3401} {utilization  0.00} {runtime 4 35 3 19} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 11407} {cell_count 3355} {utilization  0.00} {runtime 4 39 3 22} }{reify {wns 29286} {tns 0} {vep 0} {area 4759} {cell_count 1583} {utilization  0.00} {runtime 6 45 4 27} }{global_incr_map {wns 29205} {tns 0} {vep 0} {area 4697} {cell_count 1578} {utilization  0.00} {runtime 0 45 0 28} }}
...
## Written on 02:20:55 10-Jan 2023
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 0519eeec-6915-4421-8e8e-ef8bf8bd2d03}

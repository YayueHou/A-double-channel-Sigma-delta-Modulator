#################################################################################
#
# Created by Genus(TM) Synthesis Solution 18.17-s015_1 on Mon Jan 09 21:53:24 PST 2023
#
#################################################################################

## library_sets
create_library_set -name default_emulate_libset_max \
    -timing { /home/eda/gpdk45_home/ADC_Design/LIB/slow_vdd1v0_basicCells.lib }
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { ./syn//dsm_dem_top_chip.default_emulate_constraint_mode.sdc }

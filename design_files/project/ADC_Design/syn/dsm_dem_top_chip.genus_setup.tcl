...
###########################################################
if {[::legacy::find -design design:dsm_dem_chip] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj design:dsm_dem_chip
}
...
########################################################
source ./syn/dsm_dem_top_chip.genus_init.tcl
read_metric -id current ./syn/dsm_dem_top_chip.metrics.json

source ./syn/dsm_dem_top_chip.g
...
# slack
set _slk_ [::legacy::get_attribute slack design:dsm_dem_chip]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns design:dsm_dem_chip]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area design:dsm_dem_chip]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area design:dsm_dem_chip]
